...
export default function HikeMap({
  ...
  return (
    <div
      className="relative overflow-hidden rounded-2xl border border-sky-200/50 shadow-sm"
      style={{ height }}
    >
      <MapContainer
        center={center}
      ...
      {showLegend && (
        <div className="absolute bottom-3 left-3 z-[1000] hidden flex-col gap-1 rounded-xl border border-sky-200/60 bg-white/90 px-3 py-2 text-xs text-slate-700 shadow backdrop-blur-sm md:flex">
