    ...
    >
      ...
      <div className="p-4">
        ...
        {route.start_location && (
          <p className="mb-3 text-xs text-[#C07820]">Ort: {route.start_location}</p>
        )}

        <div className="mb-3 flex flex-wrap gap-3 text-xs text-[#C07820]">
        ...
        <div className="mb-3 text-xs text-[#C07820]/75">
        ...
        <div className="flex gap-2">
          ...
          <Link to={`${createPageUrl("EditRoute")}?id=${route.id}`}>
            <Button variant="ghost" size="icon" className="text-[#7C3020] hover:bg-brand-100/80">
