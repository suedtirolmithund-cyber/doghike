const UserNotRegisteredError = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-brand-50 via-white to-brand-50/20 px-4">
      <div className="w-full max-w-md rounded-2xl border border-brand-400/30 bg-gradient-to-br from-brand-700 via-brand-600 to-[#2777b8] p-8 text-white shadow-[0_18px_42px_rgba(168,0,60,0.2)]">
