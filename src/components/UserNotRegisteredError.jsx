const UserNotRegisteredError = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-brand-50 via-white to-brand-50/20 px-4">
      <div className="w-full max-w-md rounded-2xl border border-brand-100/70 bg-gradient-to-br from-brand-800 via-brand-400 to-brand-100 p-8 text-white shadow-[0_18px_42px_rgba(168,0,60,0.2)]">
        <div className="text-center">
          ...
          <h1 className="mb-4 text-2xl font-bold leading-tight text-white">Zugriff eingeschränkt</h1>
