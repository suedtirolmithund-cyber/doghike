...
const buttonVariants = cva(
  "inline-flex max-w-full min-w-0 items-center justify-center gap-2 whitespace-normal break-words rounded-xl text-center text-sm font-bold leading-tight transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_span]:min-w-0 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
      ...
      size: {
        ...
        sm: "min-h-11 px-4 py-2 text-sm font-semibold md:min-h-10 md:text-xs",
