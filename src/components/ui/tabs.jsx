...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-9 items-center justify-center rounded-lg border border-brand-100/75 bg-white/58 p-1 text-[#7C3020] shadow-sm backdrop-blur-sm md:min-h-[58px] md:rounded-2xl md:p-1.5",
      className
    )}
    {...props} />
))
