...
export default function WeatherWidget({ location, latitude, longitude }) {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-2xl p-6 border border-sky-200/50">
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-sky-200/70 bg-white/70 p-4 shadow-[0_12px_28px_rgba(16,47,74,0.08)] backdrop-blur-sm md:p-5"
    >
      ...
      {/* Aktuell */}
      <div className="mb-3 rounded-xl border border-sky-200/60 bg-white/58 p-3 backdrop-blur-sm">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {weather.daily.time.slice(0, 3).map((dateStr, i) => {
              ...
              return (
                <div key={dateStr} className="rounded-xl border border-sky-200/60 bg-white/55 p-2 text-center backdrop-blur-sm">
