  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="mx-auto max-w-2xl rounded-2xl border border-brand-400/30 bg-gradient-to-br from-brand-700 via-brand-600 to-[#2777b8] p-5 text-white shadow-[0_18px_42px_rgba(95,36,29,0.2)] md:p-6">
