          ...
          >
            ...
            >
              <div className="text-center mb-5">
                ...
                <p className="text-stone-500 text-sm mt-2">M�chtest du jetzt direkt einen Tagebucheintrag f�r diese Wanderung erstellen?</p>`r`n                <p className="text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 mt-3">Zusatzangaben wie Fotos, Wasser, Jahreszeit, Bewertung und Hinweise werden nur �bernommen, wenn du den Tagebucheintrag jetzt direkt erstellst.</p>
              </div>
