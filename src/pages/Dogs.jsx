            ...
            <AnimatePresence>
              {dogs.map((dog, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative h-48 bg-gradient-to-br from-[#FDF0E8] via-white to-[#F9C030]/30">
                      <img
            ...
            <div className="bg-gradient-to-b from-brand-50/70 via-white to-brand-50/80 px-5 py-6 md:px-8 md:py-8">
              <div className="rounded-[24px] border border-brand-100/80 bg-white/78 p-5 shadow-[0_18px_34px_rgba(168,0,60,0.10)] backdrop-blur-sm md:p-6">
                ...
                <button
                  ...
                  className="mt-4 flex w-full flex-row items-center justify-start gap-4 rounded-[22px] border border-brand-100 bg-gradient-to-r from-white via-brand-50/70 to-brand-50 px-5 py-5 text-left shadow-[0_14px_26px_rgba(168,0,60,0.10)] transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_30px_rgba(240,112,48,0.13)]"
                >
