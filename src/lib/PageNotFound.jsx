...
export default function PageNotFound() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-50 via-white to-brand-50/20 p-6">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-brand-100/70 bg-gradient-to-br from-brand-800 via-brand-400 to-brand-100 p-8 text-center text-white shadow-[0_18px_42px_rgba(168,0,60,0.2)]">
